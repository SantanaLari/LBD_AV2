...
-- QUARTAS DE FINAL
CRIAR  FUNÇÃO fn_quartas(@grupo CHAR ( 1 ))
...
COMEÇAR
	INSERIR  NA @tabela
	SELECT  TOP ( 2 ) nomeTime FROM fn_placarGrupo(@grupo) ORDER POR pontos DESC , vitórias DESC , gols_marcados DESC , saldo_gols DESC
	RETORNA
FIM
